...
---
This document shows the pipeline followed to create Transcriptome Matrix 1 (TM1). Using datasets 2,3 and 4.
...
write.table(Transcriptome_datas2and3, "Transcriptome Matrix(Data2 and 3).txt", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
